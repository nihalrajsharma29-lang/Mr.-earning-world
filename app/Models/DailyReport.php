    ...
    */
    ...
    protected function casts(): array
    {
        return [
            ...
            'nudity_sexual_behavior_non_friend_calls' => 'integer',
            'nudity_sexual_dress_non_friend_calls' => 'integer',
            'fake_user_in_screen_non_friend_calls' => 'integer',
            'black_screen_non_friend_calls' => 'integer',
            'no_user_in_screen_non_friend_calls' => 'integer',
            'male_in_screen_non_friend_calls' => 'integer',
            'underage_person_in_screen_all_calls' => 'integer',
            'nudity_sexual_behavior_friend_calls' => 'integer',
            'nudity_sexual_dress_friend_calls' => 'integer',
            'snapshots_time' => 'datetime',
    ...
    public function getAgentFeeUsdAttribute($value): mixed
    {
        ...
        if ($weeklyRewardBase <= 0) {
            $weeklyRewardBase = (float) ($this->weekly_reward_base_usd_before_strike_hosts ?? 0);
        }
        if ($weeklyRewardBase <= 0) {
            $weeklyRewardBase = (float) ($this->hosts_final_reward_usd ?? 0);
        }
