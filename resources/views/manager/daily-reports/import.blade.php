...
@section('title', 'Manager - Import Reports')
...
@section('content')
    <div class="import-card">
        ...
        <form action="{{ route('manager.daily.import.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="actions">
                ...
                <a href="{{ route('manager.reports', ['report_type' => 'daily_report']) }}" class="btn-secondary">← Back to Reports</a>
            </div>
        </form>
    </div>
@endsection
